...
foreach ($file in $files) {
    ...
    $nameMap = @{
        'D_D' = 'D.D.'
        'Pot of Deck Analyis' = 'Pot of Greed'
        'Sylvan Deck Analyis' = 'Sylvan'
        'Mathmech Deck Analyis' = 'Mathmech'
        'Junk Deck Analyis' = 'Junk'
        'Tindangle Deck Analyis' = 'Tindangle'
        'Windwitch Deck analysis' = 'Windwitch'
        'Super Quant Deck analysis' = 'Super Quant'
        'Roid deck Analysis' = 'Roid'
        'Spirit message Deck' = 'Spirit Message'
        'Spirit monster Deck' = 'Spirit Monster'
        'Xtra Hero Deck' = 'Extra Hero'
        'Yummy Archetype Deep Dive' = 'Yummy'
    }
    
    if ($nameMap.ContainsKey($archetypeName)) {
        $archetypeName = $nameMap[$archetypeName]
    }
    
    # Find the banlist section and add deck search after it
    # Look for the section containing banlist-status
