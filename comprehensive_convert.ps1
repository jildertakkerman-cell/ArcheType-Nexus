...
Write-Host "Total files processed: $($files.Count)"</content>
<parameter name="filePath">c:\Users\jilde\Documents\VSCode-Projects-main\Apps\ArcheType Nexus\comprehensive_convert.ps1